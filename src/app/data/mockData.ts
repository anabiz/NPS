...
const handwrittenProjects: Project[] = [
  ...
  },
  {
    ...
    media: [
      { id: 'init-m6', type: 'image', url: '/images/transport-infrastructure.jpeg', caption: 'Road before rehabilitation', date: '2023-02-01', tag: 'before' },
      { id: 'init-m7', type: 'image', url: '/images/borehole-drilling.jpeg', caption: 'Completed dual carriageway', date: '2025-11-15', tag: 'after' },
  ...
  },
  {
    ...
    media: [
      { id: 'init-m9', type: 'image', url: '/images/benin-asaba.jpeg', caption: 'Construction flagged off March 2025', date: '2025-03-23', tag: 'progress' },
  ...
  },
  {
    ...
    media: [
      { id: 'init-m10', type: 'image', url: '/images/road-rehabilitation-before.jpeg', caption: 'Rail corridor planning phase', date: '2025-02-15', tag: 'progress' },
  ...
  {
    id: 'init-012',
    name: 'State of Emergency on Food Security',
    sector: 'Agriculture',
    location: 'Nationwide',
    state: 'FCT Abuja',
    status: 'in-progress',
    ...
    spent: 362940000000,
    jobsCreated: 0,
    description: 'On July 13, 2023, President Tinubu declared food security a national security matter, elevating food and water availability into the National Security Council\'s purview and unlocking immediate fiscal support. The declaration released \u20a6100 billion in fertiliser support immediately and activated 500,000 hectares of mapped land nationwide for immediate farming. The agriculture budget has more than tripled in two years — from \u20a6228.4 billion (1.05% of budget) in 2023, to \u20a6362.94 billion (1.32%) in 2024, to \u20a6826.5 billion (1.7%) in 2025 — serving as the foundational policy underpinning all subsequent agricultural programmes.',
    media: [
      { id: 'init-m23', type: 'video', url: 'https://www.youtube.com/embed/s_lbNAJiluQ', thumbnail: '/images/agricultural-project.jpeg', caption: 'President Tinubu Declares State of Emergency on Food Security (TVC News)', date: '2023-07-13', tag: 'progress' },
      { id: 'init-m23b', type: 'video', url: 'https://www.youtube.com/embed/YVQtnjhbw_E', thumbnail: '/images/agricultural-project.jpeg', caption: 'Full Declaration Video (Viable TV)', date: '2023-07-13', tag: 'progress' },
      { id: 'init-m23c', type: 'video', url: 'https://www.youtube.com/embed/Kn80-bMFWu4', thumbnail: '/images/agricultural-project.jpeg', caption: 'Arise News — The Morning Show discussion', date: '2023-07-14', tag: 'progress' },
    ],
    impact: { beneficiaries: 100000000 },
  },
  {
    id: 'agr-001',
    name: 'Renewed Hope Agricultural Mechanisation Programme',
    sector: 'Agriculture',
    location: 'Nationwide',
    state: 'FCT Abuja',
    status: 'in-progress',
    ...
    spent: 0,
    jobsCreated: 16000,
    description: 'The single largest agricultural mechanisation drive in Nigeria\'s history, delivering 2,000 tractors, 10 combine harvesters, 12 mobile workshops, 9,000+ implements, and 9,000 spare part kits via a Nigeria-Belarus partnership formalised in September 2024. Launched on June 23, 2025, each tractor services approximately 600 hectares per year, collectively impacting 1.2 million farmers across 1.5 million hectares nationwide. The programme directly benefits over 550,000 farming households, targets cultivation of over 550,000 hectares, and is projected to produce 2+ million metric tons of staple food annually.',
    media: [
      { id: 'agr-001-m1', type: 'image', url: 'https://cdn.thenationonlineng.net/wp-content/uploads/2025/06/23164650/Tinubu.jpg', caption: 'Tractors lined up for distribution at Abuja launch', date: '2025-06-23', tag: 'progress' },
      { id: 'agr-001-m2', type: 'image', url: 'https://trekafrica.net/wp-content/uploads/2025/06/FB_IMG_1750744122927.jpg', caption: 'President Tinubu at tractor launch ceremony', date: '2025-06-23', tag: 'progress' },
      { id: 'agr-001-m3', type: 'image', url: 'https://media.kanyidaily.com/2025/06/23162909/Tinubu-farm.jpg', caption: 'Tinubu at podium with tractors — Renewed Hope Mechanisation launch', date: '2025-06-23', tag: 'progress' },
      { id: 'agr-001-v1', type: 'video', url: 'https://www.youtube.com/embed/o98EVt8uFmg', thumbnail: 'https://cdn.thenationonlineng.net/wp-content/uploads/2025/06/23164650/Tinubu.jpg', caption: 'Premium Times — Tinubu Launches 2,000 Tractors for Nigerian Farmers', date: '2025-06-23', tag: 'progress' },
      { id: 'agr-001-v2', type: 'video', url: 'https://www.youtube.com/embed/uE1TKw9Wj-g', thumbnail: 'https://cdn.thenationonlineng.net/wp-content/uploads/2025/06/23164650/Tinubu.jpg', caption: 'TVC News — Full Launch Ceremony Coverage', date: '2025-06-23', tag: 'progress' },
      { id: 'agr-001-v3', type: 'video', url: 'https://www.youtube.com/embed/G6o24EbsjsM', thumbnail: 'https://cdn.thenationonlineng.net/wp-content/uploads/2025/06/23164650/Tinubu.jpg', caption: 'TV360 Nigeria — Mechanisation Programme Explainer', date: '2025-06-23', tag: 'progress' },
      { id: 'agr-001-v4', type: 'video', url: 'https://www.youtube.com/embed/K3SLGbmFCF0', thumbnail: 'https://cdn.thenationonlineng.net/wp-content/uploads/2025/06/23164650/Tinubu.jpg', caption: "Chief Abiola on Nigeria's Farming Future — Farmers' reaction interview", date: '2025-06-24', tag: 'progress' },
    ],
    impact: { beneficiaries: 1200000 },
  },
  {
    id: 'agr-002',
    name: 'Presidential Fertilizer Initiative (PFI 3.0)',
    sector: 'Agriculture',
    location: 'Nationwide',
    state: 'FCT Abuja',
    status: 'in-progress',
    ...
    spent: 0,
    jobsCreated: 0,
    description: "Nigeria's central fertiliser supply-chain programme, securing raw materials for domestic blending plants and distributing subsidised inputs to smallholder farmers. Since inception, the PFI has cumulatively delivered 128+ million bags of fertiliser, with 648,000 metric tonnes produced in 2025 alone. The 2026 target is 22 million bags (1.1 million metric tonnes) — double the 2025 output — with \u20a661 billion+ in savings claimed from strategic contracting. In 2026, oversight was restructured from NSIA to the Ministry of Finance. However, the subsidised arm has so far distributed only 515,720 bags to 128,930 farmers across 25 states and the FCT — just 2.5% of the 22 million bag headline target — and farmer associations have raised concerns about potential price hikes (fertiliser at \u20a658,000/100kg) ahead of the 2027 elections.",
    media: [
      { id: 'agr-002-m1', type: 'image', url: 'https://cdn.thenationonlineng.net/wp-content/uploads/2025/08/17070019/NSIA.jpg', caption: 'FGN Presidential Fertilizer Initiative branded bag', date: '2025-08-17', tag: 'progress' },
      { id: 'agr-002-m2', type: 'image', url: 'https://von.gov.ng/wp-content/uploads/2025/09/lie-2-1-696x295.webp', caption: 'Fertiliser handling at blending plant', date: '2025-09-17', tag: 'progress' },
      { id: 'agr-002-m3', type: 'image', url: 'https://kosofepost.com/wp-content/uploads/2024/09/IMG-20240903-WA0030.jpg', caption: 'Distribution to 1,200 farmers, Lagos East', date: '2024-09-03', tag: 'progress' },
      { id: 'agr-002-v1', type: 'video', url: 'https://www.youtube.com/embed/SnrvcxoBxfM', thumbnail: 'https://cdn.thenationonlineng.net/wp-content/uploads/2025/08/17070019/NSIA.jpg', caption: 'Dangote Fertiliser Plant Commissioning — predecessor infrastructure', date: '2022-01-01', tag: 'before' },
    ],
    impact: { beneficiaries: 128930 },
  },
  {
    id: 'agr-003',
    name: 'NAGS-AP Dry Season Farming & Wheat Programme',
    sector: 'Agriculture',
    location: 'Nationwide (16+ states)',
    state: 'FCT Abuja',
    status: 'in-progress',
    progress: 55,
    ...
    spent: 0,
    jobsCreated: 0,
    description: 'The National Agricultural Growth Scheme–Agro-Pocket (NAGS-AP) is a year-round, multi-cycle cultivation programme designed to reduce Nigeria\'s reliance on rain-fed agriculture, with a strong focus on wheat self-sufficiency. In the 2023/2024 cycle, 107,429 farmers were supported with output valued at \u20a6474.6 billion. The 2024/2025 cycle scaled to 279,297 farmers with output valued at \u20a6893.75 billion. The current 2025/2026 cycle targets 80,000 registered farmers across 40,000 hectares in 16 wheat-producing states, with an expected output of ~\u20a6160 billion. Dry season expansion in 2025 covers 500,000 hectares total, including 118,000 hectares of wheat across 15 states. The programme is expanding southward — Cross River was added in 2025 for the first time.',
    media: [
      { id: 'agr-003-m1', type: 'image', url: 'https://dailytrust.com/wp-content/uploads/2024/04/an-irrigated-rice-farm.jpg', caption: 'Irrigated rice farm under dry-season cultivation', date: '2024-04-01', tag: 'progress' },
      { id: 'agr-003-m2', type: 'image', url: 'https://independent.ng/wp-content/uploads/IMG-20251006-WA0158.jpg', caption: 'Rainfed wheat field — farmers and officials', date: '2025-10-06', tag: 'progress' },
      { id: 'agr-003-m3', type: 'image', url: 'https://leadership.ng/wp-content/uploads/2025/01/Revival-of-Wheat-Farming-in-Lubero-2.jpg', caption: 'Wheat harvest — Adamawa women farmers', date: '2025-01-01', tag: 'after' },
      { id: 'agr-003-m4', type: 'image', url: 'https://agriculture.gov.ng/wp-content/uploads/2025/11/WhatsApp-Image-2025-11-15-at-7.29.27-PM-1536x862.jpeg', caption: 'NAGS-AP flag-off event, Jigawa/Borno', date: '2025-11-15', tag: 'progress' },
      { id: 'agr-003-v1', type: 'video', url: 'https://www.youtube.com/embed/7rx-lHDU7Zg', thumbnail: 'https://dailytrust.com/wp-content/uploads/2024/04/an-irrigated-rice-farm.jpg', caption: 'NTA Live — Tinubu Government Pushes for Food Security Through Wheat Farming in Plateau', date: '2025-01-01', tag: 'progress' },
      { id: 'agr-003-v2', type: 'video', url: 'https://www.youtube.com/embed/Wz7waXVX6Lg', thumbnail: 'https://dailytrust.com/wp-content/uploads/2024/04/an-irrigated-rice-farm.jpg', caption: 'Dry Season Farming + Cost-Effective Irrigation Techniques Explainer', date: '2025-01-01', tag: 'progress' },
      { id: 'agr-003-v3', type: 'video', url: 'https://www.youtube.com/embed/e84Il2BnT7g', thumbnail: 'https://dailytrust.com/wp-content/uploads/2024/04/an-irrigated-rice-farm.jpg', caption: 'Evaluation of the Success of NAGS-AP Programme on Wheat Production', date: '2025-01-01', tag: 'progress' },
    ],
    impact: { beneficiaries: 279297 },
  },
  {
    id: 'agr-004',
    ...
    spent: 1000000000000,
    jobsCreated: 12300000,
    description: 'Launched in 2015 under the Buhari administration, the Anchor Borrowers Programme (ABP) transformed Nigerian agriculture for seven years — raising rice production from ~2 million to 7.5 million tons per year, supporting 4.8 million farmers, and creating 12.3 million direct and indirect jobs across the value chain. Over \u20a61 trillion was disbursed by the Central Bank of Nigeria. However, mass defaults forced its effective suspension — the loan repayment rate stands at only 40%, with a 60% default rate. A CBN audit published in November 2025 found \u20a6629.04 billion in outstanding loans unrecovered as of December 2022. Farmer associations are simultaneously working with the EFCC, DSS, and Police to recover defaulted loans while lobbying the Tinubu administration for an ABP 2.0 relaunch.',
    media: [],
    impact: { beneficiaries: 4800000 },
  },
  {
    id: 'agr-005',
    ...
    spent: 0,
    jobsCreated: 0,
    description: 'A new Federal Ministry of Livestock Development was carved out of the Ministry of Agriculture on July 9, 2024, specifically to address recurring farmer-herder conflicts and modernise livestock production via ranching. The ministry has 17 departments (7 technical + 6 common services), including a dedicated Ranch & Pastoral Resources Development department. Key achievements include administering 14 million livestock vaccine doses and establishing new modern animal clinics nationwide. The ministry is targeting revitalisation of 273 gazetted grazing reserves covering 4.5+ million hectares into ranches, with an ambition to grow the livestock sector GDP contribution from $32 billion to $74 billion. A pilot ranching demonstration has been established at Manchong Integrated Farms, Nasarawa, with 300+ cattle and fodder supply to Jigawa and Yobe states.',
    media: [
      { id: 'agr-005-v1', type: 'video', url: 'https://www.youtube.com/embed/I8BRkuqQuNE', thumbnail: '/images/agricultural-project.jpeg', caption: "TVC News — Ministry Aims to Increase Nigeria's Livestock GDP from $32bn to $74bn", date: '2024-07-09', tag: 'progress' },
      { id: 'agr-005-v2', type: 'video', url: 'https://www.youtube.com/embed/jQxzOfWyqfc', thumbnail: '/images/agricultural-project.jpeg', caption: 'News Central TV — Nigeria Unveils Transition Plan from Open Grazing to Ranching', date: '2024-07-09', tag: 'progress' },
      { id: 'agr-005-v3', type: 'video', url: 'https://www.youtube.com/embed/S91VH7vdDNw', thumbnail: '/images/agricultural-project.jpeg', caption: 'NTA — Katsina State Creates Ministry of Livestock Development', date: '2024-07-09', tag: 'progress' },
      { id: 'agr-005-v4', type: 'video', url: 'https://www.youtube.com/embed/Z0YoMRqo3Bk', thumbnail: '/images/agricultural-project.jpeg', caption: 'NTA — Enugu State Leads Livestock Revolution with New Development Project', date: '2024-07-09', tag: 'progress' },
    ],
    impact: { beneficiaries: 10000000 },
  },
  {
    id: 'agr-006',
    name: 'Nigerian Farmers Soil Health Scheme (NFSHS)',
    sector: 'Agriculture',
    location: 'Nationwide (774 LGAs)',
    state: 'FCT Abuja',
    status: 'in-progress',
    progress: 10,
    ...
    spent: 0,
    jobsCreated: 774,
    description: 'Launched in October 2025, the Nigerian Farmers Soil Health Scheme (NFSHS) is a data-driven national initiative to improve crop yields and cut fertiliser waste through tailored, soil-specific recommendations and a new national soil database. The scheme plans 774 soil testing laboratories — one per Local Government Area — and will issue personalised soil health cards to farmers, backed by the Nigeria Soil Information System (NiSIS) digital database. The nationwide lab rollout is ongoing and not yet complete. The scheme complements the 2.15 million bags of fertiliser already distributed and the 500,000 hectares under cultivation via the biosecurity farming initiative.',
    media: [],
    impact: { beneficiaries: 5000000 },
  },
  {
    id: 'agr-007',
    name: 'Renewed Hope Smallholder Agricultural Financing Programme',
    sector: 'Agriculture',
    location: 'Nationwide',
    state: 'FCT Abuja',
    status: 'in-progress',
    ...
    spent: 0,
    jobsCreated: 0,
    description: 'Launched in July 2026 in partnership with the Bank of Agriculture, this single-digit interest financing scheme aims to nearly triple Nigeria\'s annual grain output by scaling smallholder access to affordable credit and inputs. \u20a6250 billion has been mobilised for 1 million smallholder farmers (1 hectare each) in the 2026 wet season, delivered as a 9% interest lending facility via the Bank of Agriculture, backed by a \u20a650 billion catalytic seed fund with the Bank of Industry. The programme targets raising national grain production from ~11 million tonnes to 25 million tonnes per year. Phase 1 covers 500,000 farmers in the current season, scaling to 2 million farmers next year and 5 million at full scale. Twenty farm aggregators have been selected from 1,240 applicants for the pilot phase.',
    media: [],
    impact: { beneficiaries: 500000 },
  },
  {
    id: 'init-013',
  ...
  {
    id: 'init-015',
    name: 'Abuja–Kaduna–Zaria–Kano Road Rehabilitation',
    sector: 'Infrastructure',
    location: 'Abuja to Kano Corridor',
    state: 'FCT Abuja',
    status: 'in-progress',
    progress: 22,
    startDate: '2024-01-01',
    endDate: '2030-12-31',
    budget: 1238000000000,
    spent: 270000000000,
    jobsCreated: 5000,
    description: 'Rehabilitation and reconstruction of the critical Abuja–Kaduna–Zaria–Kano highway corridor, one of Nigeria\'s busiest inter-regional routes connecting the Federal Capital Territory to the commercial hub of Kano. With a total budget of ₦1.238 trillion, ₦270 billion (22%) has been released and disbursed as of 2025. The project covers road widening, bridge repairs, drainage improvements, and full pavement reconstruction across the corridor.',
    media: [
      { id: 'init-m28', type: 'image', url: '/images/road-construction-progress.jpeg', caption: 'Road rehabilitation works in progress', date: '2025-04-10', tag: 'progress' },
    ],
    impact: { beneficiaries: 30000000, roadsBuilt: 0 },
  },
  {
    id: 'init-016',
    name: 'Renewed Hope Housing Programme',
    sector: 'Infrastructure',
    location: 'Nationwide',
    state: 'FCT Abuja',
    status: 'in-progress',
    ...
    spent: 50000000000,
    jobsCreated: 252800,
    description: 'The Renewed Hope Housing Programme targets the construction of 100,000 housing units across Nigeria to address the country\'s severe housing deficit. As of November 2024, the programme has verified 252,800 jobs created across construction and ancillary sectors. Approximately 6–10% of the 100,000-unit target has been delivered or is under active construction, with sites activated across multiple states under the Federal Ministry of Housing and Urban Development.',
    media: [
      { id: 'init-m29', type: 'image', url: '/images/housing-project.jpeg', caption: 'Renewed Hope housing units under construction', date: '2024-11-01', tag: 'progress' },
    ],
    impact: { beneficiaries: 1260000 },
  },
  // ─── ORIGINAL HANDWRITTEN PROJECTS ───
  {
    ...
    spent: 66300000000,
    jobsCreated: 8500,
    description: 'Rehabilitation and reconstruction of the Lagos-Ibadan expressway. The rehabilitation phase is 90-92% complete; however, the Federal Government has ordered a full concrete rebuild of the road, superseding the earlier asphalt rehabilitation work.',  
    media: [
