...
const handwrittenProjects: Project[] = [
  // ─── FLAGSHIP INITIATIVE PROJECTS ───
  {
    ...
    spent: 2984000000000,
    jobsCreated: 10000,
    description: 'Renamed the "President Bola Ahmed Tinubu Coastal Highway" in July 2026, this 700km, 10-lane rigid pavement expressway connects Lagos to Calabar through eight coastal states. Officially commenced in March 2024, the first 47.47km phase (Section I, Lagos) is being constructed by Hitech Construction Company Limited and is ~98% complete. Section II (Ogun) is ~60% complete; Section III (Akwa Ibom/Cross River) is ~20-30%; Section IV (Ogun/Ondo) is ~5-20%; Section V has been awarded but not started. At an estimated ₦15-15.6 trillion (~US$12.5 billion), it is the most expensive infrastructure project in Africa. Notable controversies include cost overruns, environmental assessment gaps, and demolition/compensation disputes affecting 300+ households.',
    media: [
      { id: 'init-m1', type: 'image', url: 'https://dailytrust.com/wp-content/uploads/2025/10/coastal-772x400.jpg', caption: 'Before — Unpaved corridor, muddy terrain along the coastal route', date: '2025-10-01', tag: 'before' },
      { id: 'init-m2', type: 'image', url: 'https://cdn.thenationonlineng.net/wp-content/uploads/2025/12/16055459/Lagos-Calaber-coastal-highway-543x340.jpeg', caption: 'After — Completed Lagos section opened to traffic', date: '2025-12-16', tag: 'after' },
      { id: 'init-m3', type: 'image', url: 'https://www.nairaland.com/attachments/19836301_cymera20260309083629_jpeg4e33f10482c088238b4b33a8dc2ac093', caption: 'Progress — Concrete pavement construction underway', date: '2026-03-09', tag: 'progress' },
      { id: 'init-m1v1', type: 'video', url: 'https://www.youtube.com/embed/sQm4aIIfRV0', thumbnail: 'https://img.youtube.com/vi/sQm4aIIfRV0/hqdefault.jpg', caption: '1-Year Before & After Drone Footage (Apr 2024–Dec 2025)', date: '2025-12-01', tag: 'progress' },
      { id: 'init-m1v2', type: 'video', url: 'https://www.youtube.com/embed/AS7qzuvWwXw', thumbnail: 'https://img.youtube.com/vi/AS7qzuvWwXw/hqdefault.jpg', caption: 'Full Lagos Section Tour — April 2026 Update (33 min)', date: '2026-04-01', tag: 'progress' },
      { id: 'init-m1v3', type: 'video', url: 'https://www.youtube.com/embed/4ze1BSNFwo0', thumbnail: 'https://img.youtube.com/vi/4ze1BSNFwo0/hqdefault.jpg', caption: 'Commissioning Ceremony — President Tinubu, May 2025', date: '2025-05-01', tag: 'progress' },
    ],
  ...
  },
  {
    ...
    spent: 300000000000,
    jobsCreated: 0,
    description: 'The Sokoto–Badagry Superhighway is a 1,068km (extended to 1,100km) corridor linking Lagos to Sokoto through seven states, first conceived under the Shagari administration and revived under President Tinubu. The project includes a planned rail corridor in the median. Section I (Sokoto) is ~40% complete; Section II (Kebbi) is ~60% complete; Section III (Ogun) is ~18% complete; Section IV (Oyo) is at mobilisation stage only. The \u20a6961 billion budget covers Section II/Kebbi alone. Over 300 houses were destroyed in Ogun State (Atan-Ota) due to setback/demolition confusion, with compensation disputed as of July 2026.',
    media: [
      { id: 'init-m4', type: 'image', url: 'https://www.nairaland.com/attachments/19836301_cymera20260309083629_jpeg4e33f10482c088238b4b33a8dc2ac093', caption: 'Progress — Construction in Lagos/Ogun section', date: '2026-03-09', tag: 'progress' },
      { id: 'init-m4v1', type: 'video', url: 'https://www.youtube.com/embed/Po-tPs4NV6w', thumbnail: 'https://img.youtube.com/vi/Po-tPs4NV6w/hqdefault.jpg', caption: 'Groundbreaking Ceremony — Full Event, Oct 2024 (2 hrs)', date: '2024-10-01', tag: 'progress' },
      { id: 'init-m4v2', type: 'video', url: 'https://www.youtube.com/embed/j6V6uy5DkxY', thumbnail: 'https://img.youtube.com/vi/j6V6uy5DkxY/hqdefault.jpg', caption: 'Sokoto–Badagry Highway Is Changing Fast — 40km Construction Update', date: '2026-01-24', tag: 'progress' },
    ],
  ...
  },
  {
    ...
    media: [
      ...
      { id: 'init-m19v1', type: 'video', url: 'https://www.youtube.com/embed/91B5pk8ZN0U', thumbnail: 'https://img.youtube.com/vi/91B5pk8ZN0U/hqdefault.jpg', caption: 'NELFUND — Student Loan Programme Overview', date: '2025-01-01', tag: 'progress' },
      { id: 'init-m19v2', type: 'video', url: 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Fshare%2Fr%2F19Xr14QJvb%2F&show_text=false', thumbnail: '/images/students-loan.jpeg', caption: 'NELFUND Disbursement — Facebook Report 1', date: '2025-01-01', tag: 'progress' },
      { id: 'init-m19v3', type: 'video', url: 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Fshare%2Fr%2F1CNYCNFdnR%2F&show_text=false', thumbnail: '/images/students-loan-1.jpeg', caption: 'NELFUND Disbursement — Facebook Report 2', date: '2025-01-01', tag: 'progress' },
    ],
  ...
  },
  {
    ...
    media: [
      { id: 'init-m23', type: 'video', url: 'https://www.youtube.com/embed/s_lbNAJiluQ', thumbnail: 'https://img.youtube.com/vi/s_lbNAJiluQ/hqdefault.jpg', caption: 'President Tinubu Declares State of Emergency on Food Security (TVC News)', date: '2023-07-13', tag: 'progress' },
      { id: 'init-m23b', type: 'video', url: 'https://www.youtube.com/embed/YVQtnjhbw_E', thumbnail: 'https://img.youtube.com/vi/YVQtnjhbw_E/hqdefault.jpg', caption: 'Full Declaration Video (Viable TV)', date: '2023-07-13', tag: 'progress' },
      { id: 'init-m23c', type: 'video', url: 'https://www.youtube.com/embed/Kn80-bMFWu4', thumbnail: 'https://img.youtube.com/vi/Kn80-bMFWu4/hqdefault.jpg', caption: 'Arise News — The Morning Show discussion', date: '2023-07-14', tag: 'progress' },
    ],
    impact: { beneficiaries: 100000000 },
  },
  {
    ...
    media: [
      ...
      { id: 'agr-001-v1', type: 'video', url: 'https://www.youtube.com/embed/o98EVt8uFmg', thumbnail: 'https://img.youtube.com/vi/o98EVt8uFmg/hqdefault.jpg', caption: 'Premium Times — Tinubu Launches 2,000 Tractors for Nigerian Farmers', date: '2025-06-23', tag: 'progress' },
      { id: 'agr-001-v2', type: 'video', url: 'https://www.youtube.com/embed/uE1TKw9Wj-g', thumbnail: 'https://img.youtube.com/vi/uE1TKw9Wj-g/hqdefault.jpg', caption: 'TVC News — Full Launch Ceremony Coverage', date: '2025-06-23', tag: 'progress' },
      { id: 'agr-001-v3', type: 'video', url: 'https://www.youtube.com/embed/G6o24EbsjsM', thumbnail: 'https://img.youtube.com/vi/G6o24EbsjsM/hqdefault.jpg', caption: 'TV360 Nigeria — Mechanisation Programme Explainer', date: '2025-06-23', tag: 'progress' },
      { id: 'agr-001-v4', type: 'video', url: 'https://www.youtube.com/embed/K3SLGbmFCF0', thumbnail: 'https://img.youtube.com/vi/K3SLGbmFCF0/hqdefault.jpg', caption: "Chief Abiola on Nigeria's Farming Future — Farmers' reaction interview", date: '2025-06-24', tag: 'progress' },
    ],
  ...
  },
  {
    ...
    media: [
      ...
      { id: 'agr-003-v1', type: 'video', url: 'https://www.youtube.com/embed/7rx-lHDU7Zg', thumbnail: 'https://img.youtube.com/vi/7rx-lHDU7Zg/hqdefault.jpg', caption: 'NTA Live — Tinubu Government Pushes for Food Security Through Wheat Farming in Plateau', date: '2025-01-01', tag: 'progress' },
      { id: 'agr-003-v2', type: 'video', url: 'https://www.youtube.com/embed/Wz7waXVX6Lg', thumbnail: 'https://img.youtube.com/vi/Wz7waXVX6Lg/hqdefault.jpg', caption: 'Dry Season Farming + Cost-Effective Irrigation Techniques Explainer', date: '2025-01-01', tag: 'progress' },
      { id: 'agr-003-v3', type: 'video', url: 'https://www.youtube.com/embed/e84Il2BnT7g', thumbnail: 'https://img.youtube.com/vi/e84Il2BnT7g/hqdefault.jpg', caption: 'Evaluation of the Success of NAGS-AP Programme on Wheat Production', date: '2025-01-01', tag: 'progress' },
    ],
  ...
  },
  {
    ...
    media: [
      { id: 'agr-005-v1', type: 'video', url: 'https://www.youtube.com/embed/I8BRkuqQuNE', thumbnail: 'https://img.youtube.com/vi/I8BRkuqQuNE/hqdefault.jpg', caption: "TVC News — Ministry Aims to Increase Nigeria's Livestock GDP from $32bn to $74bn", date: '2024-07-09', tag: 'progress' },
      { id: 'agr-005-v2', type: 'video', url: 'https://www.youtube.com/embed/jQxzOfWyqfc', thumbnail: 'https://img.youtube.com/vi/jQxzOfWyqfc/hqdefault.jpg', caption: 'News Central TV — Nigeria Unveils Transition Plan from Open Grazing to Ranching', date: '2024-07-09', tag: 'progress' },
      { id: 'agr-005-v3', type: 'video', url: 'https://www.youtube.com/embed/S91VH7vdDNw', thumbnail: 'https://img.youtube.com/vi/S91VH7vdDNw/hqdefault.jpg', caption: 'NTA — Katsina State Creates Ministry of Livestock Development', date: '2024-07-09', tag: 'progress' },
      { id: 'agr-005-v4', type: 'video', url: 'https://www.youtube.com/embed/Z0YoMRqo3Bk', thumbnail: 'https://img.youtube.com/vi/Z0YoMRqo3Bk/hqdefault.jpg', caption: 'NTA — Enugu State Leads Livestock Revolution with New Development Project', date: '2024-07-09', tag: 'progress' },
    ],
  ...
  {
    id: 'init-015',
    name: 'Abuja–Kaduna–Zaria–Kano Dual Carriageway',
    sector: 'Infrastructure',
    ...
    spent: 270000000000,
    jobsCreated: 0,
    description: 'Reconstruction of the ~354km Abuja–Kaduna–Zaria–Kano dual carriageway, designed for a 50–100 year lifespan with concrete pavement standards. Total budget is ₦1.238 trillion (₦286bn Section I + ₦502bn Section II + ₦450bn Abuja-Kano lot). Approximately ₦270 billion (~22%) has been disbursed as 30% mobilisation on each contract. Physical completion percentage has not been disclosed by the ministry; a 14-month completion timeline was targeted from the 2025 restart.',
    media: [
      { id: 'init-m28', type: 'image', url: 'https://dailytrust.com/wp-content/uploads/2020/08/julius-berger-reference-abuja-kano-road-1200x900.jpg', caption: 'Before — Deteriorated single carriageway', date: '2020-08-01', tag: 'before' },
      { id: 'init-m28b', type: 'image', url: 'https://fmino.gov.ng/wp-content/uploads/2025/01/Abuja-Kaduna-Zaria-Kano-Dual-Carriageway05.jpg', caption: 'Reconstruction in progress (Federal Ministry of Works)', date: '2025-01-01', tag: 'progress' },
      { id: 'init-m28v1', type: 'video', url: 'https://www.youtube.com/embed/-SJqwKdyjik', thumbnail: 'https://fmino.gov.ng/wp-content/uploads/2025/01/Abuja-Kaduna-Zaria-Kano-Dual-Carriageway05.jpg', caption: 'Official Documentary — "50-Year Highway Revolution" (30 min)', date: '2025-01-01', tag: 'progress' },
    ],
    impact: { beneficiaries: 30000000, roadsBuilt: 354 },
  },
  {
    id: 'init-016',
    name: 'Renewed Hope Cities & Estates (Housing)',
    sector: 'Infrastructure',
    location: 'Nationwide',
    state: 'FCT Abuja',
    status: 'in-progress',
    ...
    spent: 11500000000,
    jobsCreated: 252800,
    description: 'The flagship federal affordable housing programme delivering city-scale and estate-scale developments across all 36 states plus the FCT, targeting 100,000 units nationally. As of November 2024, 252,800 jobs have been verified from 10,112 units under active construction (~25 jobs/unit), with 152,000+ of these jobs specifically in Northern Nigeria (Aug 2025). The 2025 budget covers 20,000 units (₦11.5bn) while Phase 2 allocates ₦500bn for 100,000 units. A Social Housing Programme targeting 77,400 units and 2 million jobs is projected but not yet under construction.',
    media: [
      { id: 'init-m29', type: 'image', url: 'https://techsphere.com.ng/wp-content/uploads/2025/08/Renewed-Hope-Estate-Karsana.webp', caption: 'Under construction — Karsana, Abuja', date: '2025-08-01', tag: 'progress' },
      { id: 'init-m29b', type: 'image', url: 'https://cdn.thenationonlineng.net/wp-content/uploads/2024/12/31064656/Renewed-hope-housing-estate-Abuja.jpg', caption: 'Completed units — Abuja estate', date: '2024-12-31', tag: 'after' },
    ],
    impact: { beneficiaries: 1260000 },
  },
  {
    id: 'init-017',
    name: 'Eko Bridge Rehabilitation',
    sector: 'Infrastructure',
    ...
    spent: 0,
    jobsCreated: 0,
    description: 'A critical Lagos Island connector bridge that underwent structural rehabilitation and was reopened in July 2023. However, the outbound carriageway was closed again in May 2026 after five support piles failed, requiring emergency repairs. The repair scope includes pile replacement, pier cap reinforcement, and full-span lifting.',
    media: [
      { id: 'init-m30', type: 'image', url: 'https://cdn.businessday.ng/2020/03/Eko-Bridge.jpg', caption: 'Before — Damaged bridge structure', date: '2020-03-01', tag: 'before' },
      { id: 'init-m30b', type: 'image', url: 'https://thestreetjournal.org/wp-content/uploads/2023/07/FB_IMG_1688914191337.jpg', caption: 'After — Reopened following rehabilitation, July 2023', date: '2023-07-01', tag: 'after' },
    ],
    impact: { beneficiaries: 5000000 },
  },
  // ─── ORIGINAL HANDWRITTEN PROJECTS ───
  {
    ...
    spent: 66300000000,
    jobsCreated: 0,
    description: 'Nigeria\'s busiest commercial corridor (135–164km) linking Lagos to the South-West. The original rehabilitation reached 90–92% completion by September 2025, cutting travel time from 3–4 hours to ~90 minutes. However, sections failed within five years, prompting the Federal Government to order a full concrete rebuild with reinforced pavement in July 2026, resetting much of the timeline. Land values along the corridor rose 25–40% following the November 2025 ₦43bn FEC approval.',
    media: [
      { id: 'm1', type: 'image', url: 'https://www.nairaland.com/attachments/8367578_whatsappimage20181222at12_54_02_jpeg_jpeg7041eed81bf81bfca483a419db6b1043', caption: 'Before/After — Cracked road vs. restored surface', date: '2025-09-01', tag: 'before' },
      { id: 'm2', type: 'video', url: 'https://www.youtube.com/embed/O-7eZkoGNM8', thumbnail: 'https://www.nairaland.com/attachments/8367578_whatsappimage20181222at12_54_02_jpeg_jpeg7041eed81bf81bfca483a419db6b1043', caption: 'Construction & Expansion Update — CCTV camera footage', date: '2026-01-01', tag: 'progress' },
    ],
    impact: { beneficiaries: 2000000, roadsBuilt: 135 },
  },
  {
    id: 'proj-002',
